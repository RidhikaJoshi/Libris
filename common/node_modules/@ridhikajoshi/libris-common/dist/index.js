...
exports.bookSchema = zod_1.z.object({
    ...
    category: zod_1.z.enum(['FICTION', 'NON_FICTION', 'BIOGRAPHY', 'MATH', 'HISTORY', 'SCIENCE', 'PHILOSOPHY', 'OTHER']),
    ...
    publication: zod_1.z.coerce.date(),
...
exports.bookUpdateSchema = zod_1.z.object({
    ...
    category: zod_1.z.enum(['FICTION', 'NON_FICTION', 'BIOGRAPHY', 'MATH', 'HISTORY', 'SCIENCE', 'PHILOSOPHY', 'OTHER']).optional(),
    ...
    publication: zod_1.z.coerce.date().optional(),
});
